...
class BaseTrainer:
    def __init__(self, config, resume: bool, model, optimizer, loss_function):
        ...
        self.start_epoch = 1  # Not in the config file, will be updated if resume is True
        self.best_score = 0.0 if self.find_max else 100  # Not in the config file, will be updated in training and if resume is True
