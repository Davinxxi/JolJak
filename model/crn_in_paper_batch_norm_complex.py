...
class CRNN(nn.Module):
    ...
    def __init__(self):
        ...
        # Encoder
        self.conv1 = nn.Conv2d(in_channels=2, out_channels=16, kernel_size=(2, 3), stride=(1, 2))   # 2-ch input : Real, Imag
        ...
        self.convT5 = nn.ConvTranspose2d(in_channels=32, out_channels=2, kernel_size=(2, 3), stride=(1, 2))
        self.bnT5 = nn.BatchNorm2d(num_features=2)      # 2-ch output : Real, Imag
    ...
    def forward(self, x):
        ...
        # (B, o_c, T. F)
        res5 = F.softplus(self.bnT5(self.convT5(res4)))
        return res5.squeeze()
